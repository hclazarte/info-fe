    ...
    <div className="flex items-center gap-2 mb-4">
      ...
      {busqueda && (
        <button
          ...
          className="px-4 py-2 bg-inf8 hover:bg-inf3 text-white rounded-xl text-xl"
        >
          x
        </button>
      )}
      ...
      <button
        ...
        className="px-3 py-2 bg-inf8 hover:bg-inf3 text-white rounded-xl text-4xl md:hidden"
      >
        {filtrosAbiertos ? "▲" : "☰"}
      </button>
    </div>
